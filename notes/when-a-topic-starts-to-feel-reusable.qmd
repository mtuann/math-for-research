...
- [Topics](../topics/index.qmd) is where the objects are taught cleanly.
- [Applications](../applications/index.qmd) is where those objects start doing real work.
- [Paper Lab](../paper-lab/index.qmd) is where reusable understanding gets tested against actual papers.
- [Publication](../publication/index.qmd) is where reusable understanding starts turning into research judgment.
