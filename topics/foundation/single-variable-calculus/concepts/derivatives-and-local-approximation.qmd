...
- if the derivative is positive, the function is locally increasing
- if the derivative is negative, the function is locally decreasing
...
- [OpenStax Calculus Volume 1: Linear Approximations and Differentials](https://openstax.org/books/calculus-volume-1/pages/4-2-linear-approximations-and-differentials) - `Paper bridge` - useful bridge from derivative computation to approximation and error thinking. Checked `2026-04-25`.
