...
This is the limit of Riemann sums formed by partitioning the interval $[a,b]$ into small pieces and sampling the function on each piece.
...
- [Paul's Online Math Notes: Definition of the Definite Integral](https://tutorial.math.lamar.edu/Classes/CalcI/DefnofDefiniteIntegral.aspx) - `Paper bridge` - practice-heavy explanation of Riemann-sum intuition and net change. Checked `2026-04-25`.
