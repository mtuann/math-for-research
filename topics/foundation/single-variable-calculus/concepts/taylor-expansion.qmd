...
1. [Partial Derivatives and Gradients](../../multivariable-calculus/concepts/partial-derivatives-and-gradients.qmd), because Taylor-style local modeling is even more powerful in several variables
...
- [OpenStax Calculus Volume 2: Working with Taylor Series](https://openstax.org/books/calculus-volume-2/pages/6-4-working-with-taylor-series) - `Second pass` - useful bridge from the basic formula to practical approximation work. Checked `2026-04-25`.
