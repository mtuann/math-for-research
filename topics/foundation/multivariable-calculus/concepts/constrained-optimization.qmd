...
If $f$ has a local constrained extremum at a point on the smooth constraint $g(x,y)=c$, and $\nabla g \ne 0$ there, then
...
1. [Multiple Integrals](multiple-integrals.qmd), because that is the other major multivariable branch before vector-calculus depth
...
- [Paul's Online Math Notes: Lagrange Multipliers](https://tutorial.math.lamar.edu/classes/calciii/LagrangeMultipliers.aspx) - `Paper bridge` - worked-example companion for repetition and constraint-set reasoning. Checked `2026-04-25`.
