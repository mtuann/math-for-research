...
If $f$ is differentiable at $(x,y)$ and $g,h$ are differentiable at $(u,v)$, and
...
- [Paul's Online Math Notes: Tangent Planes and Linear Approximations](https://tutorial.math.lamar.edu/Classes/CalcIII/TangentPlanes.aspx) - `Second pass` - practice-heavy bridge from formulas to local linear approximation. Checked `2026-04-25`.
