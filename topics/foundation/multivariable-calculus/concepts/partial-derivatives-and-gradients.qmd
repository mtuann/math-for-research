...
- [OpenStax Calculus Volume 3: Directional Derivatives and the Gradient](https://openstax.org/books/calculus-volume-3/pages/4-6-directional-derivatives-and-the-gradient) - `Second pass` - strong free bridge from coordinate-wise rates to the gradient geometry. Checked `2026-04-25`.
