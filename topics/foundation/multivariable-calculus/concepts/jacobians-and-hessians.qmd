...
1. [Constrained Optimization](constrained-optimization.qmd), because local gradient and Hessian information become actionable under constraints
2. [Optimization](../../../advanced/optimization/index.qmd), to see first-order and second-order models become algorithms and certificates
3. [Backpropagation and Computation Graphs](../../../../applications/machine-learning/backpropagation-and-computation-graphs.qmd), to see Jacobian-style composition reasoning in ML form
...
- [OpenStax Calculus Volume 3: Chapter 4 Introduction](https://openstax.org/books/calculus-volume-3/pages/4-introduction) - `Paper bridge` - useful free bridge tying partials, linear approximations, chain rule, and optimization-style extrema together. Checked `2026-04-25`.
