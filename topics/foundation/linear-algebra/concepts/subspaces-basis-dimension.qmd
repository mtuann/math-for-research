...
The best next move is to continue the linear algebra spine with [Orthogonality and Least Squares](orthogonality-and-least-squares.qmd), where subspaces become approximation targets and column space becomes a geometric object you project onto.

## Optional Paper Bridge

- [Deep learning, transformers and graph neural networks: a linear algebra perspective](https://link.springer.com/article/10.1007/s11075-025-02218-2) - `Second pass` - a modern survey that keeps returning to low-dimensional structure, embeddings, and matrix-based representations in current AI systems. Checked `2026-04-24`.
- [A Survey: Potential Dimensionality Reduction Methods](https://arxiv.org/abs/2502.11036) - `Paper bridge` - useful once subspace ideas feel natural and you want to see how reduced representations appear across common ML pipelines. Checked `2026-04-24`.
