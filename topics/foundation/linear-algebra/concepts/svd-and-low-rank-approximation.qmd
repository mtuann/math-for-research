...
1. [Eckart-Young and Truncated SVD](../proofs/eckart-young-and-truncated-svd.qmd) for the proof
2. [PCA Through SVD](../applications/pca-through-svd.qmd) for the cleanest application framing
3. [Computation Lab: Rank-1 Approximation and PCA Geometry](../labs/rank-one-approximation-and-pca-geometry.qmd) for visual and numerical intuition
...
- [Exercises: SVD and Low-Rank Approximation](../exercises/svd-and-low-rank-approximation.qmd)
