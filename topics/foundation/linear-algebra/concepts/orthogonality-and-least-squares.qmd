...
1. [Projection Theorem and Normal Equations](../proofs/projection-theorem-and-normal-equations.qmd) for the full derivation
2. [Linear Regression Through Projection](../applications/linear-regression-through-projection.qmd) for the cleanest application framing
3. [Computation Lab: Projection Geometry and Regression Residuals](../labs/orthogonality-and-least-squares-geometry.qmd) for visual and numerical intuition
...
- [Exercises: Orthogonality and Least Squares](../exercises/orthogonality-and-least-squares.qmd)
